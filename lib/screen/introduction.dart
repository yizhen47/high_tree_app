...
class _WithBuilder extends State<WithBuilder> {
  ...
  List<ItemData> data = [
    ItemData(Colors.blue, "assets/logo.png", "Hi", "欢迎打开长安大学辅学软件", "HighTree"),
    ItemData(Colors.deepPurpleAccent, "assets/logo.png", "这里是一个主界面", "先导入并加载题库",
        "再开始刷题"),
    ItemData(Colors.green, "assets/logo.png", "这里是个人主页", "你可以自定义你的信息", "并且不会被上传"),
    ItemData(Colors.yellow, "assets/logo.png", "主页往左滑", "查看数据统计！",
        "你的学习计划完成得如何了？"),
    ItemData(
        Colors.pink, "assets/logo.png", "此外", "主页和刷题界面都可以看到", "笔记和错题本功能"),
    ItemData(Colors.red, "assets/logo.png", "Do", "try it", "Thank you"),
  ];
