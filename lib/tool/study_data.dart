...
class StudyData{
  ...
  StudyType getStudyType(){
    return StudyType.values[sharedPreferences!.getInt("studyType") ?? StudyType.testMode.index];
  }
  ...
  StudyDifficulty getStudyDifficulty(){
    return StudyDifficulty.values[sharedPreferences!.getInt("studyDifficulty") ?? StudyDifficulty.normal.index];
  }
